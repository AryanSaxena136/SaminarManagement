      ...
      <p>What's the benefits</p>
            ...
            <div id="seminarBenefitsCarousel" class="carousel slide" data-bs-interval="3000" data-bs-pause="false"
                ...
                <div class="position-relative">
                    <!-- Carousel -->
                    <div id="seminarImageCarousel" class="carousel slide" data-bs-ride="carousel"
      ...
      <div class="carousel-inner">
        ...
        <div class="content">
            <section class="intro-section">
                <div class="intro-text">
                    ...
                    <p>
                        Swami Keshvanand Institute of Technology, Management & Gramothan (SKIT) inspired from the
                        learnings of Swami Keshvanand, was established in the year 2000 by Technocrats and Managers
                        Society of Advanced Learning and Gramothan. Today the institute is recognized as one of the
                        centers of academic excellence in Northern India. The Institute is affiliated to Rajasthan
                        Technical University, Kota for offering Postgraduate and Graduate Courses in Engineering and
                        Management. Our sister institution Swami Keshvanand Institute of Pharmacy (SKIP) is affiliated
                        to Rajasthan University of Health Sciences for offering Graduate Course in Pharmacy.
                    </p>
                </div>
        ...
        <section class="vision-section">
            ...
            <div class="vision-text">
                <h2>Vision</h2>
                <p>
                    To promote higher learning in advanced technology, management skills and industrial research to make
                ...
                <p>
                    ...
                    co-curricular activities, industry institution interaction, research & development, continuing
